...
// Fallback exercise list for assignments created before exercise selection feature
const fallbackExercises: Record<string, { name: string; target: { tr: string; en: string } }[]> = {
  chest:       [{ name: 'Dumbbell Fly', target: { tr: 'Göğüs (Pektoral)', en: 'Chest (Pectoral)' } }, { name: 'Bench Press', target: { tr: 'Göğüs, Triceps, Ön Omuz', en: 'Chest, Triceps, Front Shoulder' } }, { name: 'Push-Up', target: { tr: 'Göğüs, Triceps, Core', en: 'Chest, Triceps, Core' } }],
  legs:        [{ name: 'Squat', target: { tr: 'Quadriceps, Hamstring, Glute', en: 'Quadriceps, Hamstrings, Glutes' } }, { name: 'Romanian Deadlift', target: { tr: 'Hamstring, Glute, Bel', en: 'Hamstrings, Glutes, Lower Back' } }, { name: 'Lunge', target: { tr: 'Quadriceps, Glute, Denge', en: 'Quadriceps, Glutes, Balance' } }],
  shoulders:   [{ name: 'Lateral Raise', target: { tr: 'Deltoid (Yan)', en: 'Lateral Deltoid' } }, { name: 'Shoulder Press', target: { tr: 'Deltoid (Ön/Yan), Triceps', en: 'Front/Lateral Deltoid, Triceps' } }, { name: 'Face Pull', target: { tr: 'Arka Deltoid, Rotator Cuff', en: 'Rear Deltoid, Rotator Cuff' } }],
  arms:        [{ name: 'Bicep Curl', target: { tr: 'Biceps Brachii', en: 'Biceps Brachii' } }, { name: 'Tricep Dip', target: { tr: 'Triceps Brachii', en: 'Triceps Brachii' } }, { name: 'Hammer Curl', target: { tr: 'Brachialis, Ön Kol', en: 'Brachialis, Forearm' } }],
  back:        [{ name: 'Lat Pulldown', target: { tr: 'Latissimus Dorsi, Biceps', en: 'Latissimus Dorsi, Biceps' } }, { name: 'Bent-Over Row', target: { tr: 'Orta Sırt, Rhomboid, Biceps', en: 'Mid Back, Rhomboids, Biceps' } }, { name: 'Deadlift', target: { tr: 'Tüm Arka Zincir', en: 'Full Posterior Chain' } }],
  cardio:      [{ name: 'Jump Rope', target: { tr: 'Kalp-Damar, Koordinasyon', en: 'Cardiovascular, Coordination' } }, { name: 'Jumping Jacks', target: { tr: 'Tüm Vücut, Kardiyo', en: 'Full Body, Cardio' } }, { name: 'Burpee', target: { tr: 'Tüm Vücut, HIIT', en: 'Full Body, HIIT' } }],
  calisthenics:[{ name: 'Pull-Up', target: { tr: 'Lat, Biceps, Üst Sırt', en: 'Lats, Biceps, Upper Back' } }, { name: 'Muscle-Up', target: { tr: 'Tüm Üst Vücut', en: 'Full Upper Body' } }, { name: 'Plank', target: { tr: 'Core, Omuz Stabilitesi', en: 'Core, Shoulder Stability' } }],
};
          ...
          <section>
            ...
            <div className="flex flex-col gap-2">
              {(assignments[selectedDay] || []).map((a: any, idx: number) => {
                ...
                // New assignments: exercises from assignment_exercises table
                // Old assignments (before table existed): fall back to full workout exercise list
